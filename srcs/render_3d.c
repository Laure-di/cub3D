...
/*   Updated: 2022/05/09 11:27:37 by lmasson          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	render_3d(t_data *data)
{
	...
	while (i < NUM_RAYS)
	{
		...
		project_wall_height = (TILE_SIZE /  (perp_distance * TILE_SIZE)) * DIST_PROJ_PLANE;
